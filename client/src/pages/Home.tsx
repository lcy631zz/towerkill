...
const PRESETS: Record<"custom" | "local", { label: string; baseUrl: string; model: string }[]> = {
  custom: [
    { label: "DeepSeek V4 Flash（快而省）", baseUrl: "https://api.deepseek.com", model: "deepseek-v4-flash" },
    { label: "DeepSeek V4 Pro（更强）", baseUrl: "https://api.deepseek.com", model: "deepseek-v4-pro" },
    ...
    { label: "OpenAI gpt-4.1-mini", baseUrl: "https://api.openai.com/v1", model: "gpt-4.1-mini" },
  ],
  local: [
