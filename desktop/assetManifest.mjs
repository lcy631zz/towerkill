...
// Chromium 可原生渲染的全部常见图片格式；TIFF/HEIC/PSD 不受浏览器内核支持，需转码后导入
...
// 三国卡牌的英文名别名（slash/jink 等）与武将拼音别名（caocao 等）
const ENGLISH_ALIAS_TO_IDS = {"Slash": ["game-001", "game-002", "game-003", "game-004", "game-005", "game-006", "game-007", "game-008", "game-009", "game-010", "game-011", "game-012", "game-013", "game-014", "game-015", "game-016", "game-017", "game-018", "game-019", "game-020", "game-021", "game-022", "game-023", "game-024", "game-025", "game-026", "game-027", "game-028", "game-029", "game-030"], "Jink": ["game-031", "game-032", "game-033", "game-034", "game-035", "game-036", "game-037", "game-038", "game-039", "game-040", "game-041", "game-042", "game-043", "game-044", "game-045"], "Dismantlement": ["game-054", "game-055", "game-056", "game-057", "game-058", "game-059"], "Snatch": ["game-060", "game-061", "game-062", "game-063", "game-064"], "Collateral": ["game-068", "game-069"], "Ex Nihilo": ["game-070", "game-071", "game-072", "game-073"], "Nullification": ["game-074", "game-075", "game-076", "game-077"], "Savage Assault": ["game-078", "game-079", "game-080"], "Archery Attack": ["game-081"], "God Salvation": ["game-082"], "Amazing Grace": ["game-083", "game-084"], "Indulgence": ["game-087", "game-088", "game-089"], "Blade": ["game-092"], "Qinggang Sword": ["game-092"], "Double Sword": ["game-094"], "Serpent Spear": ["game-096"], "Stone Axe": ["game-097"], "Halberd": ["game-098"], "Kylin Bow": ["game-099"], "Eight Diagram": ["game-100", "game-101"]};
...
export function validateManifest(manifest) {
  ...
  for (const [cardId, relativePath] of Object.entries(manifest.cards)) {
    if (!CARD_ID.test(cardId)) continue; // 跳过不认识的 ID，兼容第三方清单
    ...
    if (!IMAGE_EXTENSIONS.includes(path.posix.extname(normalized).toLowerCase())) fail(`${cardId} 的图片格式不受支持（支持 ${IMAGE_EXTENSIONS.join("、")}）。`);
...
function findIdsByName(name) {
  ...
  // 3. Official English alias match (slash / jink ...)
  for (const [en, ids] of Object.entries(ENGLISH_ALIAS_TO_IDS)) {
    if (normalizeName(en) === normalized) return [...ids];
  }

  // 4. Pinyin match (caocao / lvmeng ...)
  if (Object.prototype.hasOwnProperty.call(PINYIN_TO_IDS, normalized)) return [...PINYIN_TO_IDS[normalized]];
